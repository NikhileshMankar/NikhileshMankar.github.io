  ...
  return (
    <section className="w-full h-[90vh] md:h-[80vh] bg-[#07080a] mt-8 md:mt-16 relative overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-center overflow-hidden z-[1]">
        <UnicornScene
          projectId="kN8aUEyBNjoFs7skkt9Z"
          width={1500}
          height={900}
        />
      ...
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-[2] flex flex-col md:w-full w-[400px] items-center text-center">
        <Image
          src="/NPM.webp"
          alt="Nikhilesh Mankar"
          width={200}
          height={200}
          className="w-[120px] h-[120px] md:w-[180px] md:h-[180px] rounded-full mb-4"
          unoptimized
        />
        ...
        <span className="text-white text-sm md:text-lg font-normal tracking-[.2px] span-shadow">
          Assistant Professor <Dot className="inline-block -mx-1 md:mx-[0.5]" />{" "}
          Computer Engineer <Dot className="inline-block -mx-1  md:mx-[0.5]" />{" "}
          PhD Scholar
        </span>
      </div>
      ...
      <div className="absolute  bottom-[0px] md:-bottom-[2px] left-1/2 transform -translate-x-1/2 z-[4] hidden md:flex flex-col items-center gap-4 md:gap-6">
        <Buttonmain href="https://github.com/NikhileshMankar">
          Check out my GitHub
        </Buttonmain>

        <div className="flex flex-row items-center justify-center gap-4 w-[400px] md:w-full">
          <a
            href="mailto:mankar.nik@gmail.com"
            className="flex flex-row gap-2 items-center text-[10px] md:text-[14px] font-normal text-[#9c9c9d] hover:text-white transition-colors duration-300 group"
          >
          ...
          <a
            href="https://linkedin.com/in/nikhilesh-mankar-975040aa"
            target="_blank"
            rel="noopener noreferrer"
            className="flex flex-row gap-2 items-center  text-[12px] md:text-[14px] font-normal text-[#9c9c9d] hover:text-white transition-colors duration-300"
          >
            <Image
              src="/InBug-White.png"
              alt="InBug Logo"
              width={14}
              height={14}
              className="size-[12px] md:size-[14px] text-white z-[2]"
              unoptimized
            />
            LinkedIn
          </a>
          <div className="w-[1px] h-3 bg-[#9c9c9d]" />
          <a
            href="https://scholar.google.com/citations?hl=en&user=iSYj1MwAAAAJ"
            target="_blank"
            rel="noopener noreferrer"
            className="flex flex-row gap-2 items-center  text-[12px] md:text-[14px] font-normal text-[#9c9c9d] hover:text-white transition-colors duration-300"
          >
            <svg
              ...
              className="size-[14px] text-white z-[2]"
              fill="currentColor"
            >
