...
function StepperIndicator({
  ...
  return (
    <span
      ...
      className={cn(
        "bg-[#1b1718] text-[#8e8e95] data-[state=active]:bg-white data-[state=completed]:bg-white data-[state=active]:text-[#1b1718] data-[state=completed]:text-[#1b1718] relative flex size-6 shrink-0 items-center justify-center rounded-full text-xs font-medium",
...
function StepperSeparator({
  ...
  return (
    <div
      ...
      className={cn(
        "bg-[#1b1718] group-data-[state=completed]/step:bg-white/80 m-0.5 group-data-[orientation=horizontal]/stepper:h-0.5 group-data-[orientation=horizontal]/stepper:w-full group-data-[orientation=horizontal]/stepper:flex-1 group-data-[orientation=vertical]/stepper:h-12 group-data-[orientation=vertical]/stepper:w-0.5",
        className
      )}
      {...props}
    />
